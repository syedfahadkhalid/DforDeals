...
?>
        ...
        <div class="container">
        	 <?php 
								...
								$mobile4=sanitize(cleanInput($record4['mobile']));
								?>
           <span class="glyphicon glyphicon-phone p"><?php echo ' '.sanitize(cleanInput($mobile4))?></span>
	...
	<div id="page">
		...
		<div class="container page_block">
			...
			<header>
				...
				<div class="slider_block full_width">
                    ...
                    <?php
						...
						$img_banner1=sanitize(cleanInput($record2['Img1']));
						$img_banner2=sanitize(cleanInput($record2['Img2']));
						$img_banner3=sanitize(cleanInput($record2['Img3'])); 
					?>
						<ul class="slides">
							<li class="slide1">
							...
							<li class="slide3">
								...
								<div class="vertical_middle">
									<div class="flex_caption1 FromTop"><span class="color_text"></span></div>
            ...
            <?php 
				...
				{
					$deal_id=(int)sanitize(cleanInput($record['Deal_Id']));
					$deal_name=sanitize(cleanInput($record['Name']));
					$img=sanitize(cleanInput($record['Img_main']));
					$price=sanitize(cleanInput($record['Price']));
			?>
             ...
             <div class="col-lg-4 col-md-4 col-sm-4  thumb pad center">
                ...
                <a class="thumbnail" href="product-page.php?dealid=<?php echo $deal_id ?>">
                    ...
                    <img class="img-responsive"  style="max-height:670" src="<?php echo $img ?>" alt="">
                </a>
...
<footer class="full_width footer_block">
					...
					<div class="row" data-animated="fadeInUp">
                        ...
                        <?php 
								...
								$mobile=sanitize(cleanInput($record3['mobile']));
								$email=sanitize(cleanInput($record3['email']));
								$address=sanitize(cleanInput($record3['address']));
