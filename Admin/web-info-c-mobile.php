            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="web-info-c-mobile.php">Mobile</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" action="update-info-mobile.php" method="post" enctype="multipart/form-data">
    <!-- Text input-->

                         <div class="form-group">
                             <label class="col-md-4 control-label" for="textinput">Mobile:</label>  
                             <div class="col-md-4">
                                 <input id="textinput" name="mobile" type="text" placeholder="0300-XXXX-XXX" class="form-control input-md" required>
