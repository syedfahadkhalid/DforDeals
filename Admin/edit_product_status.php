                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Edit Status<small><?php echo 'ID: '.$deal_id.' |' ?></small><small><?php echo ' Name: '.$deal_name ?></small>
                            </h1>
                            <ol class="breadcrumb">
                                <li>
    ...
    <!-- Form Name -->
             <form class="form-horizontal" action="editproductstatus.php?dealid=<?php echo $deal_id?>" method="post" enctype="multipart/form-data">
    <!-- Text input-->
