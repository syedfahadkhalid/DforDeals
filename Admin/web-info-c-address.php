     ...
     <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="web-info-c-address.php">Address</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form class="form-horizontal" action="update-info-address.php" method="post" enctype="multipart/form-data">
    <!-- Text input-->

                         <div class="form-group">
                             <label class="col-md-4 control-label" for="textinput">Email:</label>  
                             <div class="col-md-4">
                                 <input id="textinput" name="address" type="text" placeholder="Full Address" class="form-control input-md" required>
