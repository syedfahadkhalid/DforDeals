                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Edit Price<small><?php echo 'ID: '.$deal_id.' |' ?></small><small><?php echo ' Name: '.$deal_name ?></small>
                            </h1>
                            <ol class="breadcrumb">
                                <li>
                                ...
                                <li class="active">
                                	<i class="fa fa-edit">Edit Price</i>
                                </li>
                            </ol>
                        </div>
                    </div>
    ...
    <!-- Form Name -->
             <form class="form-horizontal" action="editproductprice.php?dealid=<?php echo $deal_id ?>" method="post" enctype="multipart/form-data">
    <!-- Text input-->

                         <div class="form-group">
                             <label class="col-md-4 control-label" for="textinput">Price:</label>  
                             <div class="col-md-4">
                                 <input id="textinput" name="price" type="text" placeholder="Deal Name" class="form-control input-md" required>
