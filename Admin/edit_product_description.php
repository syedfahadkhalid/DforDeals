                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Edit Description<small><?php echo 'ID: '.$deal_id.' |' ?></small><small><?php echo ' Name: '.$deal_name ?></small>
                            </h1>
                            <ol class="breadcrumb">
                                <li>
                                ...
                                <li class="active">
                                	<i class="fa fa-edit">Edit Description</i>
                                </li>
                            </ol>
                        </div>
                    </div>
    ...
    <!-- Form Name -->
             <form class="form-horizontal" action="editproductdescription.php?dealid=<?php echo $deal_id?>" method="post" enctype="multipart/form-data">
    <!-- Text input-->

                         <div class="form-group">
                             <label class="col-md-4 control-label" for="textinput">Description:</label>  
                             <div class="col-md-4">
                                 <input id="textinput" name="desc" type="text" placeholder="Deal Name" class="form-control input-md" required>
