                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Edit Name <small><?php echo 'ID: '.$deal_id.' |' ?></small><small><?php echo ' Name: '.$deal_name ?></small>
                            </h1>
                            <ol class="breadcrumb">
                                <li>
                                ...
                                <li>
                                    <i class="fa fa-table"><a href="products.php">Products</a> </i>  
                                </li>
                                <li >
    ...
    <!-- Form Name -->
             <form class="form-horizontal" action="editproductname.php?dealid=<?php echo $deal_id?>" method="post" enctype="multipart/form-data">
    <!-- Text input-->
