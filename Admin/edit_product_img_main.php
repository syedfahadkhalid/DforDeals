                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Edit Description<br><small><?php echo 'ID: '.$deal_id ?></small><br><small><?php echo 'Name: '.$deal_name ?></small>
                            </h1>
                            <ol class="breadcrumb">
                                <li>
    ...
    <!-- Form Name -->
             <form class="form-horizontal" action="editproductimgmain.php?dealid=<?php echo $deal_id?>" method="post" enctype="multipart/form-data">
    <!-- Text input-->
